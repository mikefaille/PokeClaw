...
enum class CloudProvider(
    ...
    GOOGLE(
        ...
        models = listOf(
            CloudModel("gemini-3.5-flash", "Gemini 3.5 Flash", 1.50, 9.00, ModelTier.FAST, 1_000_000, recommended = true),
            CloudModel("gemini-3.1-pro-preview-customtools", "Gemini 3.1 Pro Custom Tools", 2.00, 12.00, ModelTier.PRO, 1_000_000),
            CloudModel("gemini-3.1-pro-preview", "Gemini 3.1 Pro Preview", 2.00, 12.00, ModelTier.PRO, 1_000_000),
            CloudModel("gemini-3-flash-preview", "Gemini 3 Flash Preview", 0.50, 3.00, ModelTier.FAST, 1_000_000),
