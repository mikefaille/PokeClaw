...
enum class CloudProvider(
    ...
    GOOGLE(
        ...
        models = listOf(
            CloudModel("gemini-3.1-pro-preview", "Gemini 3.1 Pro Preview", 2.00, 12.00, ModelTier.PRO, 2_000_000),
            CloudModel("gemini-3-flash-preview", "Gemini 3 Flash Preview", 0.50, 3.00, ModelTier.FAST, 2_000_000, recommended = true),
            CloudModel("gemini-3.1-flash-lite-preview", "Gemini 3.1 Flash-Lite Preview", 0.25, 1.50, ModelTier.LITE, 2_000_000),
